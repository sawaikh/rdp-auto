...
# Creates 20 RDPs with Windows Server 2025 in different US zones
...
echo "Creating 20 Windows Server 2025 RDP instances..."
...
echo "🎉 Done. Use Remote Desktop with external IPs and above credentials."
